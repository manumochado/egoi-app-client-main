...
class OrderProvider with ChangeNotifier {
  ...
  Future<void> placeOrder(
    ...
    notifyListeners();
    ApiResponse apiResponse =
        await orderRepo.placeOrder(addressID, couponCode, orderNote);
    _isLoading = false;
    if (apiResponse.response != null &&
        apiResponse.response.statusCode == 200) {
      _addressIndex = null;
  ...
  Future<void> placeOrderEfecty(
    ...
    notifyListeners();
    ApiResponse apiResponse =
        await orderRepo.placeOrderEfecty(addressID, couponCode, orderNote);
    _isLoading = false;
    if (apiResponse.response != null &&
        apiResponse.response.statusCode == 200) {
      _addressIndex = null;
  ...
  Future<void> placeOrderBaloto(
    ...
    notifyListeners();
    ApiResponse apiResponse =
        await orderRepo.placeOrderBaloto(addressID, couponCode, orderNote);
    _isLoading = false;
    if (apiResponse.response != null &&
        apiResponse.response.statusCode == 200) {
      _addressIndex = null;
