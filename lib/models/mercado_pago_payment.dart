import 'package:flutter_sixvalley_ecommerce/models/mercado_pago_credit_cart.dart';
import 'package:flutter_sixvalley_ecommerce/models/mercado_pago_customer.dart';
import 'package:flutter_sixvalley_ecommerce/models/mercado_pago_tax.dart';
...
class MercadoPagoPayment {
  ...
  MercadoPagoPayment.fromJsonMap2(Map<String, dynamic> json) {
    // statusDetail = json['status_detail'];
    id = json['id'].toString();
    status = json['status'];
    totalPaidAmount =
        json['transaction_details']['total_paid_amount'].toString();
  }
