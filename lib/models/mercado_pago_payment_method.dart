import 'package:flutter_sixvalley_ecommerce/models/mercado_pago_financial_institution.dart';
import 'package:flutter_sixvalley_ecommerce/models/mercado_pago_issuer.dart';

class MercadoPagoPaymentMethod {
  //para identificar el medio de pago
  String id;

  //aqui obtengo el nombre del medio de pago
  String name;
