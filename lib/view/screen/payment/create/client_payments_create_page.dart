...
class ClientPaymentsCreatePage extends StatefulWidget {
  double totalToPay;
  ClientPaymentsCreatePage({Key key, this.totalToPay}) : super(key: key);
...
class _ClientPaymentsCreatePageState extends State<ClientPaymentsCreatePage> {
  ...
  ClientPaymentsInstallmentsController _conEfecty =
      ...
      body: ListView(
        children: [
          CreditCardWidget(
            ...
            cardBgColor: ColorResources.PRIMARY_MATERIAL,
  ...
  Widget _buttonNext() {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          _con.createCardToken(widget.totalToPay);
        },
