              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return RadioListTile(
                    title: Text('${order.shippingList[widget.sellerIndex].shippingMethodList[index].title} (En un plazo de: ${order.shippingList[widget.sellerIndex].shippingMethodList[index].duration}, Con un costo de: ${
