...
import 'package:flutter_sixvalley_ecommerce/models/mercado_pago_credentials.dart';

class AppConstants {
  static const String APP_NAME = 'Egoi';
  ...
  static const String ORDER_PLACE_URI_EFECTY =
      '/api/v1/customer/order/place-efecty';
  static const String ORDER_PLACE_URI_BALOTO =
      '/api/v1/customer/order/place-baloto';
  ...
  static const String GET_SELECTED_SHIPPING_TYPE_URI =
      '/pi/v1/shipping-method/check-shipping-type';
  ...
  static MercadoPagoCredentials mercadoPagoCredentials = MercadoPagoCredentials(
    //OSCAR
    // publicKey: 'APP_USR-e708aa95-bd7c-4e21-aab9-2b5cfb306c71',
    // accessToken:
    //     'APP_USR-5236836512882628-072013-ee992e99e81d726dab6638bfb4798555-794017554'

    //JERO
    publicKey: 'APP_USR-d973e46a-91cd-4a98-b0df-932b9f039651',
    accessToken:
        'APP_USR-4578778558473139-020822-b6931a51537a8d50eb2614b1fa45a8f5-809326135',
  );
}
